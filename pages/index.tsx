...
import { Button, Container, Grid, Link, TextField, Typography, FormControlLabel, Switch, FormHelperText } from '@material-ui/core';
        ...
        <Container maxWidth="lg">
          ...
          <Typography variant="body1" gutterBottom>
            ...
            <ol>
              ...
              <li>This results in <i>{blocks}</i> blocks with one podcast and <i>{blockSize}</i> similar songs each.</li>
